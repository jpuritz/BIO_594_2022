...
png("./Day7_ClusterTree_Precut.png", 1000, 1000, pointsize=20)
...
png("./Day7_ClusterTree_PrimaryTreatment.png", 1000, 1000, pointsize=20)
...
# Second treatment 
png("./Day7_ClusterTree_SecondTreatment.png", 1000, 1000, pointsize=20)
...
png("./Day7_ClusterTree_GroupTreatment.png", 1000, 1000, pointsize=20)
...
png("./Day7_ScaleTopology_SoftThresh.png", 1000, 1000, pointsize=20)
        par(mfrow = c(1,2));
        cex1 = 0.9;
...
# Plot the result ================================================================ #
sizeGrWindow(7, 6)
png("./Day7_ClusterEigengenes.png", 1000, 1000, pointsize=20)
...
save(MEs, moduleLabels, moduleColors, file = "./Day7-networkConstruction-stepByStep.RData")
# write csv - save the module eigengenes
write.csv(MEs, file = "./d7.WGCNA_ModulEigengenes.csv")
...
png("./Day7_Treatments_Primary_heatmap2.png", 500, 1000, pointsize=20)
...
pdf("./Day7_Treatments_Primary_heatmap.pdf", width=5, height=6)
...
par(mar = c(8, 9.5, 5, 3));
# Display the correlation values within a heatmap plot
png("./Day7_Treatments_Second_heatmap2.png", 1000, 500, pointsize=20)
...
pdf("./Day7_Treatments_Second_heatmap.pdf", width=5, height=6)
...
par(mar = c(8, 9.5, 5, 3));
# Display the correlation values within a heatmap plot
png("./Day7_Group_heatmap2.png", 1000, 500, pointsize=20)
...
pdf("./Day7_Group_heatmap.pdf", width=5, height=6)
...
#plot it
png("./Day7_ME_Boxplot.png", 600, 1000, pointsize=20)
